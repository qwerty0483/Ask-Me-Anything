...
$cntSql =  "select * from information_list";
...
<body>
    ...
    <main class="board_container" id="information_list">
        <div id="board_header">
            <p id="page_title">정보 게시판</p>
        </div>
        <div id="board_main">
            <?php
            ...
            ?>
                <div class="board">
                    <a href="information_view.php?idx=<?php echo $arr['boardIdx']; ?>">
        ...
        <div id="page_num">
            ...
            if ($page > 1) {
                $page--;
                echo "<a href=\"information_list.php?page=1\" class=\"page_str\"><i class='fa-solid fa-angles-left' style='margin-right: 10px;'></i></a>";
                echo "<a href=\"information_list.php?page=$page\" class=\"page_str\"><i class='fa-solid fa-angle-left' style='margin-right: 10px;'></i></a>";
                $page = 2;
            }
            ...
            while ($pageNum <= $totalPage) {
                if ($page == $pageNum)
                    echo "<a href=\"information_list.php?page=$pageNum\" id=\"cur_page\" class=\"page_num\">$pageNum</a>";
                else
                    echo "<a href=\"information_list.php?page=$pageNum\" class=\"page_num\">$pageNum</a>";
                $pageNum++;
                echo "<span style='margin-right: 10px;'></span>";
            }
            if ($page < $totalPage) {
                $page++;
                echo "<a href=\"information_list.php?page=$page\"class=\"page_str\"><i class='fa-solid fa-angle-right' style='margin-right: 10px'></i></a>";
                echo "<a href=\"information_list.php?page=$totalPage\" class=\"page_str\"><i class='fa-solid fa-angles-right' style='margin-right: 10px'></i></a>";
            }
            ?>
        </div>
        <div id="board_write">
            <input type="button" value="글쓰기" onclick="location.href='information_write.php'" id="writeBtn" />
        </div>
    </main>
