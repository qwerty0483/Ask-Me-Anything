...
$sql = "select * from question_list where boardIdx = '$idx';";
...
$likeSql = "SELECT boardLike FROM question_like WHERE boardIdx = '$idx' AND userId = '$userId';";
...
$scrapSql = "SELECT boardScrap FROM question_scrap WHERE boardIdx = '$idx' AND userId = '$userId';";
...
<body>
    ...
    <main class="board_container" id="question_view">
        <div id="board_main">
            ...
            <div class="meta_head">
                ...
                <div id="views">조회 <?php echo $bdArr['boardViews']; ?></div>
            </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $("#goodBtn").click(function() {
                ...
                $.ajax({
                    url: 'http://localhost/php/board/question/update_like.php',
                    method: 'POST',
                    data: {
            ...
            $("#scrapBtn").click(function() {
                ...
                $.ajax({
                    url: 'http://localhost/php/board/question/update_scrap.php',
                    method: 'POST',
                    data: {
                        boardIdx: '<?php echo $idx; ?>',
                        userId: '<?php echo $userId; ?>',
