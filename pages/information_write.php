...
<body>
    ...
    <main class="board_container" id="information_write">
        <div id="board_header">
            <p id="page_title">정보 게시글 쓰기</p>
        </div>
        <form action="/php/board/information/write_proc.php" method="post" id="board_main">
            <div>
